...
export const AgentProfile: React.FC = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto px-6 py-12">
            {/* Header Card */}
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-200 dark:border-slate-700 overflow-hidden mb-12">
                <div className="h-48 bg-gradient-to-r from-slate-800 to-primary-900 relative">
                    <div className="absolute top-4 right-4 flex space-x-2">
                        <button className="bg-white/10 hover:bg-white/20 p-2 rounded-lg text-white backdrop-blur-sm transition-colors">
                            <Linkedin size={20} />
                        </button>
                        <button className="bg-white/10 hover:bg-white/20 p-2 rounded-lg text-white backdrop-blur-sm transition-colors">
                            <Instagram size={20} />
                ...
                <div className="px-8 pb-8 relative">
                        ...
                        <div className="flex gap-3 mb-2 w-full md:w-auto">
                            {agent.whatsapp && (
                                <a
                                    ...
                                    className="flex-1 md:flex-none px-6 py-3 bg-slate-900 dark:bg-slate-700 text-white rounded-lg font-medium hover:bg-slate-800 transition-colors flex items-center justify-center"
                                >
                            ...
                            <a
                                ...
                                className="flex-1 md:flex-none px-6 py-3 bg-primary-500 text-white rounded-lg font-medium hover:bg-primary-600 transition-colors shadow-lg shadow-primary-500/30"
                            >
                                Enviar Email
                            </a>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-gray-100 dark:border-slate-700 pt-8">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center p-4 bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-700">
                                    <span className="text-gray-500 dark:text-slate-400">Imóveis Ativos</span>
                                    <span className="font-bold text-xl text-gray-900 dark:text-white">{properties.length}</span>
                                </div>
                                <div className="flex justify-between items-center p-4 bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-700">
                                    <span className="text-gray-500 dark:text-slate-400">Avaliação</span>
            ...
            {/* Listings */}
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Imóveis Disponíveis</h2>
            {properties.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {properties.map(prop => (
                        <div
                            key={prop.id}
                            className="bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-sm border border-gray-200 dark:border-slate-700 group cursor-pointer hover:-translate-y-1 transition-transform duration-300"
                        ...
                        >
                            ...
                            <div className="p-5">
                                <h3 className="font-bold text-lg text-gray-900 dark:text-white mb-1 truncate">{prop.title}</h3>
                                ...
                                <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-slate-700 text-sm text-gray-500 dark:text-slate-400">
