...
export default function AboutPage() {
    ...
    return (
        <div className="bg-gray-50 dark:bg-slate-900 min-h-screen font-sans">
            {/* Hero Section */}
            <section className="relative overflow-hidden bg-slate-900 text-white py-24 lg:py-32 pt-32">
                ...
                <div className="mt-20 container mx-auto px-6 relative z-10 text-center">
                    <span className="inline-block py-1 px-3 rounded-full bg-emerald-500/20 text-emerald-400 text-xl font-semibold mb-6 backdrop-blur-sm border border-emerald-500/30">
                        Nossa Essência
                    </span>
                    ...
                    <div className="max-w-4xl mx-auto relative">
                        ...
                        <div className="relative pt-16 text-center">
                            <div className="inline-flex flex-col items-center">
                                ...
                                <div className="max-w-2xl px-6 py-8 bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl text-white shadow-2xl relative">
