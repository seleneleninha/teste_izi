...
import { ArrowLeft, Upload, Loader2, MapPin, DollarSign, Home, X, Camera } from 'lucide-react';
...
export default function AddPropertyPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            addToast('Erro ao cadastrar imóvel', 'error');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="p-6 lg:p-8">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Novo Imóvel</h1>
                    <p className="text-gray-500 dark:text-gray-400">Preencha as informações do imóvel</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="max-w-4xl">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        <div className="md:col-span-2">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 bg-gray-50 dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-white"
                            />
                        </div>
                        ...
                        <div className="md:col-span-2">
                            ...
                            <textarea
                                ...
                                className="w-full px-4 py-3 bg-gray-50 dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-white resize-none"
                            />
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 mb-6 border border-gray-100 dark:border-slate-700">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="cep" value={formData.cep} onChange={handleChange} className="w-full px-4 py-3 bg-gray-50 dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-xl text-gray-900 dark:text-white" />
                        </div>
                        <div className="md:col-span-2">
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Logradouro</label>
                            <input type="text" name="logradouro" value={formData.logradouro} onChange={handleChange} className="w-full px-4 py-3 bg-gray-50 dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-xl text-gray-900 dark:text-white" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Número</label>
                            <input type="text" name="numero" value={formData.numero} onChange={handleChange} className="w-full px-4 py-3 bg-gray-50 dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-xl text-gray-900 dark:text-white" />
                        </div>
                        <div>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 mb-6 border border-gray-100 dark:border-slate-700">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                        {photoUrls.map((url, index) => (
                            <div key={index} className="relative aspect-video bg-gray-100 dark:bg-slate-700 rounded-xl overflow-hidden">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 mb-6 border border-gray-100 dark:border-slate-700">
                    ...
                    <div className="flex flex-col gap-3">
                        <label className="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="aceita_parceria" checked={formData.aceita_parceria} onChange={handleChange} className="w-5 h-5 rounded text-emerald-500 focus:ring-emerald-500" />
                            <span className="text-gray-700 dark:text-gray-300">Aceita parceria com outros corretores</span>
                        </label>
                        <label className="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="aceita_financiamento" checked={formData.aceita_financiamento} onChange={handleChange} className="w-5 h-5 rounded text-emerald-500 focus:ring-emerald-500" />
                ...
                <div className="flex gap-4">
                    <button
                        type="button"
                        onClick={() => router.back()}
                        className="px-8 py-4 bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-gray-300 rounded-xl font-semibold hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors"
                    >
                        Cancelar
                    </button>
                    <button
                        type="submit"
                        disabled={loading}
                        className="flex-1 px-8 py-4 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl font-semibold transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                        {loading ? (
                            <>
